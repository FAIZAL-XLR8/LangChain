...
#this is the schema
class structure_format(BaseModel):
    summary:str = Field(description="write down the summary in conscise way")
    sentiment : Literal["pos", "neg"] = Field(description="positive or negative ")
    pros : Optional[list[str]] = Field (default = None, description= "give me the pros of the product")
   
    cons : Optional[list[str]] = Field (default = None, description= "give me the cons of the product")
